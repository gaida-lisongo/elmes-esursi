            ...
            <div className="rounded-lg border border-stroke bg-white p-6 shadow-solid-4 dark:border-strokedark dark:bg-blacksection">
                    ...
                    {etablissement.description && etablissement.description.length > 0 ? (
                        etablissement.description.map((desc, idx) => (
                            <div key={idx} className="group relative">
                                ...
                                {isEditing && (
                                    <div className="absolute -right-2 -top-2 hidden gap-2 bg-white p-1 shadow-sm dark:bg-blacksection group-hover:flex">
                ...
                <div className="space-y-3 border-t border-stroke pt-6 dark:border-strokedark">
                    ...
                    <div className="flex items-start gap-3 group">
                        ...
                        {isEditing && (
                            <button onClick={() => handleEditContact('adresse', etablissement.adresse || "")} className="opacity-0 group-hover:opacity-100 text-primary">
                    ...
                    <div className="flex items-center gap-3 group">
                        ...
                        {isEditing && (
                            <button onClick={() => handleEditContact('telephone', etablissement.telephone || "")} className="opacity-0 group-hover:opacity-100 text-primary">
                                <svg className="h-3 w-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                                </svg>
                            </button>
                    ...
                    <div className="flex items-center gap-3 group">
                        ...
                        {isEditing && (
                            <button onClick={() => handleEditContact('website', etablissement.website || "")} className="opacity-0 group-hover:opacity-100 text-primary">
                                <svg className="h-3 w-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                                </svg>
                            </button>
