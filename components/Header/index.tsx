...
const Header = ({ customMenuData }: { customMenuData?: Menu[] }) => {
  ...
  // Use custom menu data if provided, else default
  const menuToUse = customMenuData || menuData;
